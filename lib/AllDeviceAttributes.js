...
const defaults = {
    ...
    'led.r': {
        common: { name: 'Rot', type: 'number', role: 'state', read: true, write: true, min: 0, max: 255 },
        on: 'this.WIZ__SET_COLOR(client_ip);',
    },
    'led.g': {
        common: { name: 'Grün', type: 'number', role: 'state', read: true, write: true, min: 0, max: 255 },
        on: 'this.WIZ__SET_COLOR(client_ip);',
    },
    'led.b': {
        common: { name: 'Blau', type: 'number', role: 'state', read: true, write: true, min: 0, max: 255 },
        on: 'this.WIZ__SET_COLOR(client_ip);',
    },
    'led.c': {
        common: { name: 'Kaltweiß', type: 'number', role: 'state', read: true, write: true, min: 0, max: 255 },
        on: 'this.WIZ__SET_COLOR(client_ip);',
    },
    'led.w': {
        common: { name: 'Warmweiß', type: 'number', role: 'state', read: true, write: true, min: 0, max: 255 },
        on: 'this.WIZ__SET_COLOR(client_ip);',
    },
    'colors.rgb': {
